...
from .conflict import (
    ...
    get_conflict_stimflex_weight_config,
    get_conflict_stimflex_weightds1d_config
)
...
def get_model_config():
    ...
    return {
        ...
        "conflict_stimflex_weight": get_conflict_stimflex_weight_config(),
        "conflict_stimflex_weightds1d": get_conflict_stimflex_weightds1d_config(),
