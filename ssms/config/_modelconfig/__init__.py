...
from .conflict import (
    ...
    get_conflict_stimflex_logit_config,
    get_conflict_dsstimflex_logit_config,
    get_conflict_dsstimflexlin_logit_config,
    get_conflict_dsstimflexpwlin_logit_config,
    get_conflict_stimflex_softmax_config,
    get_conflict_stimflex_hazard_config,
...
def get_model_config():
    ...
    return {
        ...
        "conflict_stimflex_logit": get_conflict_stimflex_logit_config(),
        "conflict_dsstimflex_logit": get_conflict_dsstimflex_logit_config(),
        "conflict_dsstimflexlin_logit": get_conflict_dsstimflexlin_logit_config(),
        "conflict_dsstimflexpwlin_logit": get_conflict_dsstimflexpwlin_logit_config(),
        "conflict_stimflex_softmax": get_conflict_stimflex_softmax_config(),
        "conflict_stimflex_hazard": get_conflict_stimflex_hazard_config(),
