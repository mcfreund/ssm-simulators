...
class SimpleThetaProcessor(AbstractThetaProcessor):
    ...
    models_dynamic_drift = [
        "conflict_ds",
        "conflict_ds_angle",
        "conflict_stimflex_logit",
        "conflict_dsstimflex_logit",
        "conflict_dsstimflexlin_logit",
        "conflict_dsstimflexpwlin_logit",
        "conflict_stimflex_softmax",
        "conflict_stimflex_hazard",
